...
class JapanTripReference
{
    ...
    {
        return [
            ['source_key' => 'SAS_TOKYO_ROUTE', 'title' => 'SAS Tokyo route', 'source_type' => 'airline', 'authority' => 'SAS', 'url' => 'https://www.flysas.com/'],
            ['source_key' => 'SAS_CPH_STOPOVER', 'title' => 'SAS Copenhagen stopover', 'source_type' => 'airline', 'authority' => 'SAS', 'url' => 'https://www.flysas.com/'],
            ['source_key' => 'HND_ACCESS', 'title' => 'Haneda central Tokyo access', 'source_type' => 'rail', 'authority' => 'Tokyo Monorail', 'url' => 'https://tokyo-haneda.com/en/access/train/index.html'],
            ['source_key' => 'METS_AKIHABARA', 'title' => 'JR East Hotel Mets Premier Akihabara', 'source_type' => 'hotel', 'authority' => 'JR East Hotel Mets', 'url' => 'https://www.hotelmets.jp/en/akihabara/'],
            ['source_key' => 'TOKYO_RAMEN', 'title' => 'Tokyo Ramen Street', 'source_type' => 'food', 'authority' => 'Tokyo Station', 'url' => 'https://www.tokyoeki-1bangai.co.jp/street/ramen/en/'],
            ['source_key' => 'TOKYO_FIRST_AVENUE', 'title' => 'First Avenue Tokyo Station', 'source_type' => 'food', 'authority' => 'Tokyo Station', 'url' => 'https://www.tokyoeki-1bangai.co.jp/en/'],
            ['source_key' => 'TEAMLAB', 'title' => 'teamLab Planets', 'source_type' => 'activity', 'authority' => 'teamLab', 'url' => 'https://teamlabplanets.dmm.com/en'],
            ['source_key' => 'DISNEY_CHILD', 'title' => 'Tokyo Disney child guidance', 'source_type' => 'activity', 'authority' => 'Tokyo Disney Resort', 'url' => 'https://www.tokyodisneyresort.jp/en/tdr/guide/child-tdl.html'],
            ['source_key' => 'ROMANCECAR', 'title' => 'Odakyu Romancecar', 'source_type' => 'rail', 'authority' => 'Odakyu', 'url' => 'https://odakyu-global.com/passes/romancecar/'],
            ['source_key' => 'HAKONE_FREEPASS', 'title' => 'Hakone Freepass', 'source_type' => 'rail', 'authority' => 'Odakyu', 'url' => 'https://odakyu-global.com/passes/hakone-freepass/'],
            ['source_key' => 'TEN_YU', 'title' => 'Hakone Kowakien Ten-yu', 'source_type' => 'hotel', 'authority' => 'Hakone Kowakien Ten-yu', 'url' => 'https://www.ten-yu.com/en/'],
            ['source_key' => 'VISCHIO_KYOTO', 'title' => 'Hotel Vischio Kyoto by Granvia', 'source_type' => 'hotel', 'authority' => 'Hotel Vischio Kyoto', 'url' => 'https://www.hotelvischio-kyoto.com/en/'],
            ['source_key' => 'NISHIKI', 'title' => 'Nishiki Market', 'source_type' => 'food', 'authority' => 'Kyoto City Tourism Association', 'url' => 'https://kyoto.travel/en/destinations/kyoto-nishiki-food-market/'],
            ['source_key' => 'NARA_DEER', 'title' => 'Nara Park deer guide', 'source_type' => 'activity', 'authority' => 'Nara City Tourism Association', 'url' => 'https://narashikanko.or.jp/en/feature/deer'],
            ['source_key' => 'DOTONBORI', 'title' => 'Dotonbori and Tombori River Cruise', 'source_type' => 'activity', 'authority' => 'Osaka Convention & Tourism Bureau', 'url' => 'https://osaka-info.jp/en/spot/tombori-river-cruise/'],
            ['source_key' => 'SMARTEX_HAYATOKU', 'title' => 'SmartEX Hayatoku Nozomi fare', 'source_type' => 'rail', 'authority' => 'SmartEX', 'url' => 'https://smart-ex.jp/en/product/'],
            ['source_key' => 'JNTO_SUMMER', 'title' => 'JNTO rainy season and Obon guidance', 'source_type' => 'seasonality', 'authority' => 'JNTO', 'url' => 'https://www.japan.travel/en/'],
        ];
    }
    ...
    public static function assets(): array
    {
        return [
            ...
            'activities' => [
                ['stable_key' => 'tivoli-flex', 'name' => 'Tivoli or Copenhagen harbor walk', 'city' => 'Copenhagen', 'country' => 'Denmark', 'rain_fit' => 'medium', 'age_fit' => 'high', 'latitude' => 55.6725, 'longitude' => 12.5684],
                ...
                ['stable_key' => 'kyoto-temple-morning', 'name' => 'Kyoto temple district morning', 'city' => 'Kyoto', 'country' => 'Japan', 'rain_fit' => 'medium', 'age_fit' => 'medium', 'latitude' => 34.9949, 'longitude' => 135.7851],
                ...
                ['stable_key' => 'kyoto-kid-choice', 'name' => 'Kid choice day', 'city' => 'Kyoto', 'country' => 'Japan', 'area' => 'Umekoji / Kyoto Railway Museum', 'rain_fit' => 'high', 'age_fit' => 'high', 'reservation_url' => 'https://www.kyotorailwaymuseum.jp/en/', 'latitude' => 34.9875, 'longitude' => 135.7433, 'notes' => 'Concrete rainy-day anchor for flexible Kyoto kid-choice days; swap for another child-led pick if preferences change.'],
            ...
            'food_spots' => [
                ...
                ['stable_key' => 'station-snacks', 'name' => 'Station snacks and food halls', 'city' => 'Tokyo', 'country' => 'Japan', 'default_meal_type' => 'snack', 'latitude' => 35.6812, 'longitude' => 139.7671],
                ['stable_key' => 'convenience-store-backup', 'name' => 'Convenience store backup', 'country' => 'Japan', 'default_meal_type' => 'backup', 'fallback_type' => 'low_energy', 'notes' => 'Use the nearest 7-Eleven, Lawson, FamilyMart, or station shop to the current hotel or station; intentionally not pinned to one city.'],
                ['stable_key' => 'toyoso-lunch', 'name' => 'Toyosu lunch', 'city' => 'Tokyo', 'country' => 'Japan', 'area' => 'Toyosu', 'default_meal_type' => 'lunch', 'latitude' => 35.6491, 'longitude' => 139.7899],
                ['stable_key' => 'nishiki-tasting', 'name' => 'Nishiki tasting lunch', 'city' => 'Kyoto', 'country' => 'Japan', 'area' => 'Nishiki', 'default_meal_type' => 'lunch', 'latitude' => 35.0050, 'longitude' => 135.7647],
                ['stable_key' => 'osaka-street-food', 'name' => 'Osaka street food', 'city' => 'Osaka', 'country' => 'Japan', 'area' => 'Dotonbori', 'default_meal_type' => 'dinner', 'latitude' => 34.6687, 'longitude' => 135.5010],
                ['stable_key' => 'ryokan-dining', 'name' => 'Ryokan breakfast and dinner', 'city' => 'Hakone', 'country' => 'Japan', 'default_meal_type' => 'half_board', 'latitude' => 35.2402, 'longitude' => 139.0445],
            ],
            'transport_legs' => [
