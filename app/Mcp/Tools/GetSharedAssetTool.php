...
#[Name('get-shared-asset')]
#[Description('Get one shared accommodation, activity, food spot, or transport leg with pricing, media, and usage.')]
#[IsReadOnly]
class GetSharedAssetTool extends Tool
{
    /**
